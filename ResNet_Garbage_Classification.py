...
mc = ModelCheckpoint('ResNet_best_weights.h5', monitor='val_acc', mode='max', verbose=1, save_best_only=True)
...
plt.legend()
plt.savefig('ResNet_train_val_acc.png')
plt.figure()
...
plt.legend()
plt.savefig('ResNet_train_val_loss.png')
plt.show()
